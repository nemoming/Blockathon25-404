...
# === Dummy JobDetails and Files classes to mimic Clio-X ===
class Files:
...
class JobDetails:
    def __init__(self, path: str):
        self.files = type("FileContainer", (), {"files": [Files([path])]})

# === Use your own sample dataset here ===
dataset_path = "C:/Users/nemof/OneDrive/Desktop/Blockathon-404/Cliox-Blockathon25-main/template/_data/Enron sample dataset.csv"
job_details = JobDetails(dataset_path)
algorithm: Optional[Algorithm] = Algorithm(job_details)
